...
public class GoodsOutDetailsInfoActivity extends AppCompatActivity implements View.OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_goods_out_details_info);
...
//        TextView product_code = this.findViewById(R.id.product_code);
//        product_code.setText(String.valueOf(productID));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.backHome:
                ...
                backHome.setClass(GoodsOutDetailsInfoActivity.this, HomeMenuActivity.class);
